...
public class FigureSupplier extends ColorSupplier {
    ...
    public Figure getRandomFigure() {
        ...
        String color = getRandomColor().toLowerCase(); // виклик без colorSupplier
    ...
    public Figure getDefaultFigure() {
        return new Circle(Colors.WHITE.name().toLowerCase(), RANDOM_BOUND); // якщо getColor() повертає Colors.WHITE
    }
}
